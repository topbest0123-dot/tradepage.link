  ...
  return (
    <div style={pageWrapStyle}>
      ...
      <div style={headerCardStyle}>
        <div style={headerLeftStyle}>
          {avatarUrl ? (
            <img
              ...
              style={{ width: 48, height: 48, borderRadius: 14, objectFit: 'cover', border: '1px solid #183153', background: '#0b1524' }}
            />
          ) : (
        ...
        <div style={ctaRowStyle}>
          ...
          <button
            type="button"
            onClick={handleShare}
            style={{ padding: '8px 12px', borderRadius: 10, border: '1px solid #213a6b', background: 'transparent', color: '#eaf2ff', fontWeight: 700, cursor: 'pointer', marginLeft: 8 }}
          >
            Share
          </button>
        </div>
      ...
      <div style={grid2Style}>
        <Card title="About">
          <p style={{ marginTop: 0, marginBottom: 0, whiteSpace: 'pre-wrap', overflowWrap: 'anywhere', wordBreak: 'break-word', lineHeight: 1.5, maxWidth: '100%' }}>
...
const headerCardStyle = { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, padding: '16px 18px', borderRadius: 16, border: '1px solid #183153', background: 'linear-gradient(180deg,#0f213a,#0b1524)', marginBottom: 20 };
const headerLeftStyle = { display: 'flex', alignItems: 'center', gap: 12 };
const logoDotStyle = { width: 48, height: 48, borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#63d3e0', color: '#0a0f1c', fontWeight: 800, fontSize: 20 };
...
const btnBaseStyle = { padding: '10px 16px', borderRadius: 12, border: '1px solid #2f3c4f', textDecoration: 'none', fontWeight: 700 };
const btnPrimaryStyle = { background: 'linear-gradient(135deg,#66e0b9,#8ab4ff)', color: '#08101e', border: '1px solid #2d4e82' };
const btnNeutralStyle = { background: '#1f2937', color: '#ffffff' };

const h2Style = { margin: '0 0 10px 0', fontSize: 18 };
const cardStyle = { padding: 16, borderRadius: 16, border: '1px solid #183153', background: 'linear-gradient(180deg,#0f213a,#0b1524)', minWidth: 0 };
const grid2Style = { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 16 };
const chipStyle = { padding: '6px 12px', borderRadius: 999, border: '1px solid #27406e', background: '#0c1a2e', color: '#d1e1ff', fontSize: 13 };
const tagStyle = { fontSize: 12, padding: '2px 8px', borderRadius: 999, border: '1px solid #27406e', background: '#0c1a2e', color: '#b8ccff' };
...
const galleryItemStyle = { height: 220, borderRadius: 14, border: '1px solid #27406e', background: '#0b1627', overflow: 'hidden' };
